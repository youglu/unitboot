...
public class MagicPackageUtils {
    ...
    private static final Logger log = LoggerFactory.getLogger(MagicPackageUtils.class);
...
//        sendMagicPackage("10.0.50.186", "D8-9E-F3-95-AC-74");
        ...
        String broadcastAddress=getBroadcastAddress("[2408:8256:f183:1050:e377:1d9a:c2a3:6278]","255.255.255.0");
